...
if tipo_instalacao == "Tanques, equipamentos de processo e navios":
    v1a = st.sidebar.number_input(
        ...
        **V1** — capacidade máxima do tanque, equipamento de processo ou reservatório de maior capacidade  
...
st.sidebar.caption("""Contenção da mancha de óleo:""",
                  help="""De acordo com o cálculo da capacidade efetiva diária de recolhimento de óleo - CEDRO (Fonte: Petrobras 2011)""")
